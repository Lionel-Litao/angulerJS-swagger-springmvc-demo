...
(function () {
    ...
    as.config(function ($routeProvider, $httpProvider) {
        ...
        $routeProvider.when('/person', { controller: 'PersonController', templateUrl: 'pages/admin/person.html'});
        $routeProvider.when('/admin', { controller: 'AdminController', templateUrl: 'pages/admin/admin.html'});
